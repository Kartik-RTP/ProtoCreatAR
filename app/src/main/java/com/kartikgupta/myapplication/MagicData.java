...
public final class MagicData extends Message<MagicData, MagicData.Builder> {
  ...
  public static final class Marker extends Message<Marker, Marker.Builder> {
    ...
    public Marker(ByteString iset, ByteString fset, ByteString fset3) {
      this(iset, fset, fset3, ByteString.EMPTY);
    }

    public Marker(ByteString iset, ByteString fset, ByteString fset3, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
      this.iset = iset;
      this.fset = fset;
      this.fset3 = fset3;
    ...
    public static final class Builder extends Message.Builder<Marker, Builder> {
      ...
      public Marker build() {
        if (iset == null
            || fset == null
            || fset3 == null) {
          throw Internal.missingRequiredFields(iset, "iset",
              fset, "fset",
              fset3, "fset3");
        }
        return new Marker(iset, fset, fset3, super.buildUnknownFields());
      }
    }
    ...
    private static final class ProtoAdapter_Marker extends ProtoAdapter<Marker> {
      ...
      public int encodedSize(Marker value) {
        return ProtoAdapter.BYTES.encodedSizeWithTag(1, value.iset)
            + ProtoAdapter.BYTES.encodedSizeWithTag(2, value.fset)
            + ProtoAdapter.BYTES.encodedSizeWithTag(3, value.fset3)
            + value.unknownFields().size();
      }

      @Override
      public void encode(ProtoWriter writer, Marker value) throws IOException {
        ProtoAdapter.BYTES.encodeWithTag(writer, 1, value.iset);
        ProtoAdapter.BYTES.encodeWithTag(writer, 2, value.fset);
        ProtoAdapter.BYTES.encodeWithTag(writer, 3, value.fset3);
      ...
      public Marker decode(ProtoReader reader) throws IOException {
        ...
        for (int tag; (tag = reader.nextTag()) != -1;) {
          switch (tag) {
            case 1: builder.iset(ProtoAdapter.BYTES.decode(reader)); break;
            case 2: builder.fset(ProtoAdapter.BYTES.decode(reader)); break;
            case 3: builder.fset3(ProtoAdapter.BYTES.decode(reader)); break;
            default: {
