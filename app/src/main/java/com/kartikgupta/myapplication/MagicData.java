...
public final class MagicData extends Message<MagicData, MagicData.Builder> {
  ...
  public static final class Images extends Message<Images, Images.Builder> {
    ...
    public static final String DEFAULT_IMAGENAMEWITHEXTENSION = "";
    ...
    public final String imageNameWithExtension;

    public Images(ByteString imagebytes, String imageNameWithExtension) {
      this(imagebytes, imageNameWithExtension, ByteString.EMPTY);
    }

    public Images(ByteString imagebytes, String imageNameWithExtension, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
    ...
    public Builder newBuilder() {
      ...
      builder.imageNameWithExtension = imageNameWithExtension;
      builder.addUnknownFields(unknownFields());
      return builder;
    }
    ...
    public boolean equals(Object other) {
      ...
      return unknownFields().equals(o.unknownFields())
          ...
          && imageNameWithExtension.equals(o.imageNameWithExtension);
    }
    ...
    public int hashCode() {
      ...
      if (result == 0) {
        ...
        result = result * 37 + imageNameWithExtension.hashCode();
        super.hashCode = result;
      }
      return result;
    }
    ...
    public String toString() {
      ...
      builder.append(", imageNameWithExtension=").append(imageNameWithExtension);
    ...
    public static final class Builder extends Message.Builder<Images, Builder> {
      ...
      public Builder imageNameWithExtension(String imageNameWithExtension) {
        this.imageNameWithExtension = imageNameWithExtension;
        return this;
      }
      ...
      public Images build() {
        if (imagebytes == null
          ...
          throw Internal.missingRequiredFields(imagebytes, "imagebytes",
              imageNameWithExtension, "imageNameWithExtension");
        }
        return new Images(imagebytes, imageNameWithExtension, super.buildUnknownFields());
      }
    }
    ...
    private static final class ProtoAdapter_Images extends ProtoAdapter<Images> {
      ...
      public int encodedSize(Images value) {
        return ProtoAdapter.BYTES.encodedSizeWithTag(1, value.imagebytes)
            + ProtoAdapter.STRING.encodedSizeWithTag(2, value.imageNameWithExtension)
            + value.unknownFields().size();
      }
      ...
      public void encode(ProtoWriter writer, Images value) throws IOException {
        ...
        ProtoAdapter.STRING.encodeWithTag(writer, 2, value.imageNameWithExtension);
        writer.writeBytes(value.unknownFields());
      }
      ...
      public Images decode(ProtoReader reader) throws IOException {
        ...
        for (int tag; (tag = reader.nextTag()) != -1;) {
          switch (tag) {
            ...
            case 2: builder.imageNameWithExtension(ProtoAdapter.STRING.decode(reader)); break;
            default: {
              FieldEncoding fieldEncoding = reader.peekFieldEncoding();
              Object value = fieldEncoding.rawProtoAdapter().decode(reader);
              builder.addUnknownField(tag, fieldEncoding, value);
